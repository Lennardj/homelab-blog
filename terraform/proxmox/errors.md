...
12. Don't manually update the state of the VM with out informing terraform as you ass is grass. Namely `terraform destroy` won't work
13. Terraform output is messy, don't just assume a simple object with the value be wise and check it first
