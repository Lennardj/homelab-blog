...
%% Edge Layer
Cloudflare["Cloudflare (DNS + Tunnel + Zero Trust)"]
...
%% Application Layer
App["WordPress / Hugo"]
Database["MariaDB (PVC Storage)"]

%% Kubernetes Platform
subgraph Kubernetes Cluster
    KubeAPI["Kubernetes Control Plane"]
    Calico["Calico CNI"]
...
%% Automation Layer
subgraph Automation
    Docker["Docker Compose Pipeline"]
    Terraform["Terraform"]
    Python["Python Inventory Script"]
    Ansible["Ansible"]
end
